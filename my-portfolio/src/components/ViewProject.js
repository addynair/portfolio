  ...
  return (
    <section className="p-8 mx-auto max-w-4xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
        <img src={mainImage1} alt="Main Image 1" className="w-full h-100 bg-gray-200 rounded-lg object-cover" />
        <img src={mainImage2} alt="Main Image 2" className="w-full h-100 bg-gray-200 rounded-lg object-cover" />
        <img src={mainImage3} alt="Main Image 3" className="w-full h-100 bg-gray-200 rounded-lg object-cover" />
      </div>

      
      <div className="flex justify-between items-center text-sm font-medium text-gray-600 mb-8">
      ...
      <ul className="list-disc list-inside text-gray-700 mb-8 mx-auto max-w-prose">
        <li><strong>Intuitive Design:</strong> This project taught me about the importance of intuitive, empathetic design when dealing with sensitive topics like mental health. I had to consider how each feature would feel to users who might be going through a difficult time.</li>
        <li><strong>User Experience Focus:</strong> I learned to ask questions like, “How can this design make someone feel heard or less alone?” This led me to create a calming, distraction-free experience where colors, fonts, and spacing worked together to create a safe space.</li>
        <li><strong>Prioritization:</strong> I learned the art of prioritizing within the design process. Balancing ambition with simplicity was key—choosing features that truly enhanced user experience was essential.</li>
        <li><strong>Less is More:</strong> This project reminded me that good design isn’t always about doing more; it’s often about understanding what serves users best and doing that well.</li>
      </ul>
